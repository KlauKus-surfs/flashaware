    ...
    body: () =>
      React.createElement(
        ...
        React.createElement(
          ...
          'Five roles, ordered highest to lowest. Each role inherits the abilities of every role below it.',
        ),
        React.createElement(
          'ul',
          ...
          React.createElement(
            ...
            ' — platform owner. Manages all organisations, provisions Representatives and other Super Admins, mutates platform-level settings, monitors the EUMETSAT feed.',
          ),
          React.createElement(
            'li',
            { style: { marginBottom: 6 } },
            React.createElement('b', null, 'Representative'),
            ' — internal staff who manages many customer tenants (e.g. customer success). Same per-org reach as Admin, but across ',
            React.createElement('i', null, 'every'),
            ' org via the org-scope picker. Can view the Platform Overview (read-only). Cannot create or delete organisations, promote other Representatives or Super Admins, or change platform-level settings.',
          ),
          React.createElement(
            'li',
            { style: { marginBottom: 6 } },
            React.createElement('b', null, 'Admin'),
            ' — manages locations, recipients, users (Admin / Operator / Viewer), settings, and audit log within ',
            React.createElement('i', null, 'their own organisation'),
          ...
          React.createElement(
            ...
            ' — day-to-day operations. Can read everything in their org and acknowledge alerts. Cannot edit locations, users, or settings.',
          ),
          React.createElement(
            'li',
            null,
            React.createElement('b', null, 'Viewer'),
            ' — read-only. Sees Dashboard, locations, alert history, and replay in their org.',
          ),
        ),
        React.createElement(
          'p',
          { style: { margin: '8px 0 0 0', fontStyle: 'italic', color: 'rgba(0,0,0,0.6)' } },
          'Note: Representative and Super Admin can only be granted by an existing Super Admin. Invite links create Admin, Operator, or Viewer accounts only.',
        ),
      ),
  },
